...
Task 3:
Fabric script based off the previous task (file 2-do_deploy_web_static.py)
That creates and distributes an archive to my web servers using the func deploy
(Contains do_pack() and do_deploy() funcs from file 2-do_deploy_web_static.py)
"""
import os
